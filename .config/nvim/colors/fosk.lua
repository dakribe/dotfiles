-- Fosk theme for Neovim.
-- Ported from vscode-fosk-theme by davesnx.
...
local colors = {
	...
	red = '#f07178',
	selection = '#353660',
	transparent_black = '#252636',
	transparent_blue = '#273660',
	transparent_green = '#27402e',
	transparent_red = '#402830',
	transparent_yellow = '#403828',
	visual = '#353660',
	white = '#e0e0f0',
	yellow = '#ffcb6b',
}
...
local groups = vim.tbl_extend('error', statusline_groups, {
	...
	['@modifier'] = { fg = colors.purple },
	['@regexp'] = { fg = colors.cyan },
	...
	LspCodeLens = { fg = colors.lavender, underline = true },
